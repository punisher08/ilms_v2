    ...
    <div class="lg:px-24 lg:py-24 md:py-20 md:px-44 px-4 py-24 items-center flex justify-center flex-col-reverse lg:flex-row md:gap-28 gap-16">
        <div class="xl:pt-24 w-full xl:w-1/2 relative pb-12 lg:pb-0">
            <div class="relative">
                <div class="absolute">
                    <div class="">
                        <h1 class="my-2 text-gray-800 font-bold text-2xl">Error: 1</h1>
                        <pre class="my-2 text-gray-800 font-bold text-2xl">Error: Call to undefined method <?php echo $controllerName .'::'.$actionName;?></pre>
        ...
        <div>
            <img src="/src/images/404-svg.png" />
        </div>
    </div>
</body>
</html>